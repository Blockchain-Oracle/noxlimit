...
- [2026-07-23 revised product ideas](../ideas/2026-07-23-iexec-wtf-product-ideas.md)
- [Current product decision](../decisions/CURRENT.md)
- [Agent handoff](../../AGENT_HANDOFF.md)

QuietRound is now a backup. Some technical pages below retain QuietRound examples because they are
concrete illustrations of Nox integration constraints, not because the product has been selected.
